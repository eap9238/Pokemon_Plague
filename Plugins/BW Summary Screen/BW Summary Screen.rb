...
#=============================================================================
  ...
  def drawPageThree
    ...
    textBase = Color.new(90, 82, 82)
    textShadow = Color.new(165, 165, 173)

    if @pokemon.pokerus.severity <= 0.25
      textBase = Color.new(255, 8, 72)
      textShadow = Color.new(123, 8, 49)
    elsif @pokemon.pokerus.severity <= 0.5
      textBase = Color.new(255, 115, 0)
      textShadow = Color.new(115, 57, 0)
    elsif @pokemon.pokerus.severity <= 0.75
      textBase = Color.new(255, 214, 0)
      textShadow = Color.new(123, 99, 0)
    end

    if SHOW_EV_IV
      textpos = [
        [_INTL("HP"), 64, 82, 0, Color.new(255, 255, 255), statshadows[:HP]],
        [sprintf("%d/%d", @pokemon.hp, @pokemon.totalhp), 182, 82, 2, textBase, textShadow],
        ...
        [sprintf("%d", @pokemon.attack), 182, 132, 2, textBase, textShadow],
        ...
        [sprintf("%d", @pokemon.defense), 182, 164, 2, textBase, textShadow],
        ...
        [sprintf("%d", @pokemon.spatk), 182, 196, 2, textBase, textShadow],
        ...
        [sprintf("%d", @pokemon.spdef), 182, 228, 2, textBase, textShadow],
        ...
        [sprintf("%d", @pokemon.speed), 182, 260, 2, textBase, textShadow],
